  ...
  return (
    <main className="container-shell max-w-3xl py-14">
      ...
      <div className="mt-8 space-y-6 text-base leading-8 text-ink/75">
        ...
        <h2 className="pt-4 text-xl font-bold tracking-tight text-ink">Permitted use</h2>
        <p>
        ...
        <h2 className="pt-4 text-xl font-bold tracking-tight text-ink">Prohibited use</h2>
        ...
        <h2 className="pt-4 text-xl font-bold tracking-tight text-ink">Intellectual property</h2>
        <p>
        ...
        <h2 className="pt-4 text-xl font-bold tracking-tight text-ink">Disclaimer of warranties</h2>
        <p>
        ...
        <h2 className="pt-4 text-xl font-bold tracking-tight text-ink">Limitation of liability</h2>
        <p>
        ...
        <h2 className="pt-4 text-xl font-bold tracking-tight text-ink">Changes to these terms</h2>
        <p>
          We may revise these terms at any time. Continued use of the Service after changes are posted
          constitutes your acceptance of the revised terms.
        </p>

        <h2 className="pt-4 text-xl font-bold tracking-tight text-ink">Governing law</h2>
        <p>
        ...
        <h2 className="pt-4 text-xl font-bold tracking-tight text-ink">Contact</h2>
        <p>
          Legal enquiries:{" "}
