  ...
  return (
    <main className="container-shell max-w-3xl py-14">
      ...
      <div className="mt-8 space-y-6 text-base leading-8 text-ink/75">
        ...
        <h2 className="pt-4 text-xl font-bold tracking-tight text-ink">Information we collect</h2>
        ...
        <h2 className="pt-4 text-xl font-bold tracking-tight text-ink">How we use your information</h2>
        ...
        <h2 className="pt-4 text-xl font-bold tracking-tight text-ink">Cookies</h2>
        <p>
        ...
        <h2 className="pt-4 text-xl font-bold tracking-tight text-ink">Third-party services</h2>
        <p>
        ...
        <h2 className="pt-4 text-xl font-bold tracking-tight text-ink">Data retention</h2>
        <p>
        ...
        <h2 className="pt-4 text-xl font-bold tracking-tight text-ink">Your rights</h2>
        <p>
        ...
        <h2 className="pt-4 text-xl font-bold tracking-tight text-ink">Changes to this policy</h2>
        <p>
