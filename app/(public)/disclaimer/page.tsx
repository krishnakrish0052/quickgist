...
export default function DisclaimerPage() {
  return (
    <main className="container-shell max-w-3xl py-14">
      ...
      <h1 className="mt-2 text-4xl font-bold tracking-tight text-[var(--ink)]">Editorial Disclaimer</h1>
      ...
      <div className="mt-8 space-y-6 text-base leading-8 text-[var(--ink-soft)]">
        ...
        <h2 className="pt-4 text-xl font-bold tracking-tight text-[var(--ink)]">No professional advice</h2>
        <p>
        ...
        <h2 className="pt-4 text-xl font-bold tracking-tight text-[var(--ink)]">Source accuracy</h2>
        <p>
        ...
        <h2 className="pt-4 text-xl font-bold tracking-tight text-[var(--ink)]">Third-party sources</h2>
        <p>
        ...
        <h2 className="pt-4 text-xl font-bold tracking-tight text-[var(--ink)]">Corrections policy</h2>
        <p>
        ...
        <h2 className="pt-4 text-xl font-bold tracking-tight text-[var(--ink)]">Opinion and analysis</h2>
        <p>
